...
const ViewApplications = () => {
  return (
    <div className=' container mx-auto p-4'>
        <div >
             <table className='w-full max-w-4xl lg:max-w-6xl bg-white border border-gray-200 max-sm:text-sm'>
                <thead>
                    ...
                    {viewApplicationsPageData.map((applicant, index)=>(
                        <tr key={index} className='text-gray-700'>
                            ...
                            <td className='py-2 px-4 border-b text-center '>
                                {/* <img className='w-10 h-10 my-2 rounded-full mr-3 max-lg:hidden' src={applicant.imgSrc} alt="" /> */}
